...
const CATALOG = [
  ...
  { id: "kart",    title: "Turbo Cups",   cat: "Carreras",   emoji: "🏎️", color: "#ff7b2e", ready: true,  url: "games/kart/",   desc: "Kart 3D: drift, mini-turbo, ítems y rivales IA." },
  ...
  { id: "cards",   title: "Video Póker",  cat: "Cartas",     emoji: "🂡", color: "#22d3ee", ready: true,  url: "games/cards/",  desc: "Jacks or Better. Mantén y gana." },
  ...
  { id: "rpg",     title: "Soul Tale",    cat: "RPG",        emoji: "⚔️", color: "#a98bff", ready: true,  url: "games/rpg/",    desc: "Combate por turnos: lucha o perdona." },
  { id: "tycoon",  title: "Biz Tycoon",   cat: "Gestión",    emoji: "🍕", color: "#ff9d2e", ready: true,  url: "games/tycoon/", desc: "Gestiona tu pizzería y crece." },
  { id: "sim",     title: "Sim Lab",      cat: "Simuladores",emoji: "🛠️", color: "#3bd1ff", ready: true,  url: "games/sim/",    desc: "Sandbox de partículas: arena, agua, fuego." },
